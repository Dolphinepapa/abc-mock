  ...
  insights: [
    ...
    },
    {
      ...
      reference: {
        ...
        outcome: "7 周内 #2 → #1",
        method:
          "4 周内 TACoS 临时由 19% 升至 31% + 14 天 15% 折扣促销。在第 6 周拿下 #1。随后 6 周的回落期内,销售额保持在活动前基线 +18% — BS 光环带动自然点击 +34%,抵消了广告花费的下降。",
      },
      plan: {
        phases: [
          {
